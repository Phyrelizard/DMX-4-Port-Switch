...
// version 1.2.0
//
// PCB/perfboard-friendly pinout update:
//
// - D3 through D11 are now used for the 9 DMX address DIP switches
...
// - External status LED remains on D2
...
void handleDemoMode()
{
  ...
  // External status LED blinks while demo mode is active.
...
void handleDmxMode()
{
  // External status LED is only used for demo mode.
  digitalWrite(STATUS_LED_PIN, LOW);
